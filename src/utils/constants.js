...
export const REGISTRATION_ERROR_MESSAGE = 'Во время регистрации произошла ошибка. Возможно, проблема с соединением или пользователь с таким email уже существует';
export const REQUEST_INVALID_ERROR_MESSAGE = 'Запрос невалидный!';
export const AUTH_ERROR_MESSAGE = 'Ошибка авторизации!';
export const NOT_FOUND_ERROR_MESSAGE = 'Запрашиваемый ресурс не найден!';
export const DEFAULT_ERROR_MESSAGE = 'В процессе выполнения программы возникла ошибка';
export const CONFLICT_ERROR_MESSAGE = 'Во время регистрации произошла ошибка! Возможно, такой пользователь уже существует.';
